...
public class PageWidget extends FrameLayout {
    ...
    private OnClickPage onClickPage;
     ...
     * 事件传递
     */
    public void setOnClickPage(OnClickPage onClickPage){
        ...
        public boolean onTouch(View v, MotionEvent event) {
            if (v == PageWidget.this && mAdapter != null) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if(lastX > width && 1080 - lastX > width &&
                            lastY > height && 1920 - lastY > height){
                        onClickPage.onClick();
                        return false;
                    }

                    Log.i("yangxd", "个数" + itemCount + "下标" + currentPosition);
                    ...
                    Log.e("yangxd", "下标---" + currentPosition);
